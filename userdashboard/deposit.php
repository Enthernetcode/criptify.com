        ...
        <div class="member-container">
          ...
          <div class="member_right">
            ...
            <div style="background-color:#0000ff;" align="center">
              <font color="yellow" size="5"><b><strong>bc1q6057p9cnejr9gcucmtvnr9zknlcmdpnf5k4dq3</strong></b></font>
            </div><br><br>
            <div class="member_right">
              ...
              <div style="background-color:#0000ff;" align="center">
                <font color="yellow" size="5"><b><strong>0x082C1808eBbEA0194739D835f8D2827033E5441b</strong></b></font>
              </div>
              <br><br>
              <div class="member_right">

                <h4 align="center">Send your USDT deposit to the address below:</h4>


                <div style="background-color:#0000ff;" align="center">
                  <font color="yellow" size="5"><b><strong>0x49f624bf6570d2f163b696348b4bfb886d6d6163</strong></b></font>
                </div>
                <br><br><br>
                <br><br>
                <font color="red" size="5">
                  <marquee>Ensure to copy address properly and email a prove screenshot to info@munarcloud.com to avoid payment error
                  </marquee>
                </font><br><br><br><br>
              </div>
              <!--end column-70-->
        ...
        <div class="footerInner">
          <div class="ctn-footer-top">
            <div class="ctn-ft-left">
              <p>&copy; 2022 munarcloud.com All Rights Reserved.</p>
            </div>
